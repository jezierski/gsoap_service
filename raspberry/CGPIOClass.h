...
{
public:
    CGPIOClass();  // create a GPIO object that controls GPIO4 (default
    CGPIOClass(string x); // create a GPIO object that controls GPIOx, where x is passed to this constructor
