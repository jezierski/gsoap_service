...
public:
    ...
    virtual int getFilesList(struct ns1__getFilesListResponse &_param_4) SOAP_PURE_VIRTUAL {
        return SOAP_OK;
    }

    /// Web service operation 'uploadFirmware' (returns error code or SOAP_OK)

    virtual int uploadFirmware(std::string fileName, struct ns1__uploadFirmwareResponse &_param_5) SOAP_PURE_VIRTUAL {
        return SOAP_OK;
    }
};
#endif
