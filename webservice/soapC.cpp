...
SOAP_FMAC1 struct ns1__saveXML * SOAP_FMAC2 soap_instantiate_ns1__saveXML(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct ns1__saveXML[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct ns1__saveXMLResponse * SOAP_FMAC2 soap_instantiate_ns1__saveXMLResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct ns1__saveXMLResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct ns1__setDeviceName * SOAP_FMAC2 soap_instantiate_ns1__setDeviceName(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct ns1__setDeviceName[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct ns1__setDeviceNameResponse * SOAP_FMAC2 soap_instantiate_ns1__setDeviceNameResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct ns1__setDeviceNameResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct ns1__searchNewDevices * SOAP_FMAC2 soap_instantiate_ns1__searchNewDevices(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct ns1__searchNewDevices[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct ns1__searchNewDevicesResponse * SOAP_FMAC2 soap_instantiate_ns1__searchNewDevicesResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct ns1__searchNewDevicesResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct ns1__getXML * SOAP_FMAC2 soap_instantiate_ns1__getXML(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct ns1__getXML[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct ns1__getXMLResponse * SOAP_FMAC2 soap_instantiate_ns1__getXMLResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct ns1__getXMLResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
