...
/// Operation "ns1__getValue" of service binding "homesys"
...
Service definition of function ns__getValue
  ...
  - Addressing action: "http://adjserwer.dyndns.org/soap_server/webservice/homesys.wsdl/homesysPortType/getValue"

  - Addressing response action: "http://adjserwer.dyndns.org/soap_server/webservice/homesys.wsdl/homesysPortType/getValueResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call_ns1__getValue(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // request parameters:
...
//gsoap ns1  service method-style:	getValue rpc
//gsoap ns1  service method-encoding:	getValue http://schemas.xmlsoap.org/soap/encoding/
//gsoap ns1  service method-action:	getValue ""
//gsoap ns1  service method-output-action:	getValue http://adjserwer.dyndns.org/soap_server/webservice/homesys.wsdl/homesysPortType/getValueResponse
int ns1__getValue(
