...
{	struct soap *soap = this;
	...
	if (soap_endpoint == NULL)
		soap_endpoint = "http://192.168.1.11:1234";
	if (soap_action == NULL)
		soap_action = "";
	soap_begin(soap);
	...
	if (soap_recv_fault(soap, 1))
		return soap->error;
	soap_tmp_ns1__getXMLResponse = soap_get_ns1__getXMLResponse(soap, NULL, "", NULL);
	if (!soap_tmp_ns1__getXMLResponse || soap->error)
...
{	struct soap *soap = this;
	...
	if (soap_recv_fault(soap, 1))
		return soap->error;
	soap_get_ns1__searchNewDevicesResponse(soap, &_param_1, "", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
{	struct soap *soap = this;
	...
	if (soap_recv_fault(soap, 1))
		return soap->error;
	soap_tmp_ns1__setDeviceNameResponse = soap_get_ns1__setDeviceNameResponse(soap, NULL, "", NULL);
	if (!soap_tmp_ns1__setDeviceNameResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (soap_recv_fault(soap, 1))
		return soap->error;
	soap_tmp_ns1__saveXMLResponse = soap_get_ns1__saveXMLResponse(soap, NULL, "", NULL);
	if (!soap_tmp_ns1__saveXMLResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (soap_recv_fault(soap, 1))
		return soap->error;
	soap_tmp_ns1__switchPortResponse = soap_get_ns1__switchPortResponse(soap, NULL, "", NULL);
	if (!soap_tmp_ns1__switchPortResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (soap_recv_fault(soap, 1))
		return soap->error;
	soap_get_ns1__makeRemoteActionResponse(soap, &_param_2, "", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
{	struct soap *soap = this;
	...
	if (soap_recv_fault(soap, 1))
		return soap->error;
	soap_get_ns1__getDevicesListResponse(soap, &_param_3, "", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int homesysProxy::getFilesList(const char *endpoint, const char *soap_action, struct ns1__getFilesListResponse &_param_4)
{	struct soap *soap = this;
	...
	soap->encodingStyle = "http://schemas.xmlsoap.org/soap/encoding/";
	soap_serializeheader(soap);
	soap_serialize_ns1__getFilesList(soap, &soap_tmp_ns1__getFilesList);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_ns1__getFilesList(soap, &soap_tmp_ns1__getFilesList, "ns1:getFilesList", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_recv_fault(soap, 1))
		return soap->error;
	soap_get_ns1__getFilesListResponse(soap, &_param_4, "", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int homesysProxy::uploadFirmware(const char *endpoint, const char *soap_action, std::string fileName, struct ns1__uploadFirmwareResponse &_param_5)
{	struct soap *soap = this;
	...
	soap_begin(soap);
	soap->encodingStyle = "http://schemas.xmlsoap.org/soap/encoding/";
	soap_tmp_ns1__uploadFirmware.fileName = fileName;
	soap_serializeheader(soap);
	soap_serialize_ns1__uploadFirmware(soap, &soap_tmp_ns1__uploadFirmware);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_ns1__uploadFirmware(soap, &soap_tmp_ns1__uploadFirmware, "ns1:uploadFirmware", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_recv_fault(soap, 1))
		return soap->error;
	soap_get_ns1__uploadFirmwareResponse(soap, &_param_5, "", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
